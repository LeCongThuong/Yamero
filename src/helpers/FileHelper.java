...
public class FileHelper {
    ...
    public static int sendFile(BufferedOutputStream outSocket, String filepath) throws IOException {
    ...
    public static int receiveFile(BufferedInputStream inpSocket, String filepath, long fileSize) throws IOException {
        int bufferSize = loadBufferSize();
    ...
    public static int forwardFile(BufferedInputStream inpSocket, ArrayList<BufferedOutputStream> forwardingSockets, String filepath, long fileSize) throws IOException {
        int bufferSize = loadBufferSize();
        ...
        try {
            ...
            for (BufferedOutputStream forwardingSocket: forwardingSockets) {
